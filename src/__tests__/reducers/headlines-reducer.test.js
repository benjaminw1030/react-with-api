...
describe('HeadlinesReducer', () => {
  ...
  it('requesting headlines should successfully change isLoading form false to true', () => {
    action = {
  ...
  it('successfully getting headlines should change isLoading to false and update headlines', () => {
  ...
  it('failing to get headlines should change isLoading to false and add an error message', () => {
